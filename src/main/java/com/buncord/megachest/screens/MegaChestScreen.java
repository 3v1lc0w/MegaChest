package com.buncord.megachest.screens;
    ...
    extends AbstractContainerScreen<MegaChestContainerMenu>
{
  private static final ResourceLocation CONTAINER_BACKGROUND =
      new ResourceLocation(MegaChest.MOD_ID, "textures/gui/container/mega_chest.png");
  ...
  protected void renderLabels(@NotNull PoseStack p_98616_, int p_98617_, int p_98618_) {
    ...
    this.font.draw(
        p_98616_,
        new TranslatableComponent("block.megachest.mega_chest"),
        8.0F,
        6.0F,
        4210752
    );
