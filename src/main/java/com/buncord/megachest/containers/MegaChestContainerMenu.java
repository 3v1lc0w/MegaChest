...
public class MegaChestContainerMenu extends AbstractContainerMenu {
  ...
  public MegaChestContainerMenu(int containerID, Inventory inventory, FriendlyByteBuf buf) {
    this(containerID, inventory, getTileEntityFromBuf(buf, MegaChestBlockEntity.class));
  }
  ...
  public MegaChestContainerMenu(
    ...
    if (container != null) {
      ...
      this.container = new SimpleContainer(MegaChestBlockEntity.SIZE);
    }
